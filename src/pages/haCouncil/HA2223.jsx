  ...
  return (
    <div>
        <div className="container text-white">
            <h1 className="title text-warning text-center py-3 my-4">HA Council 2022-2023</h1>  <hr/>
            <div className="container mt-5">
              <div class="row row-cols-1 row-cols-lg-3   align-items-stretch g-4">
              <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-2 pb-3 text-shadow-1">
                    <img src={"./22-23/kartik.jpeg"} alt="Bootstrap" width="75%" style={{contentFit:"cover"}} loading='lazy'  class="rounded-circle border border-white m-auto "/>
        ...
        <div className="container ">
              ...
              <div class="col">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/himanshu.jpg"} alt="Bootstrap" width="75%"  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
                ...
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/Rishav.jpeg"} alt="Bootstrap" width="75%"  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
                ...
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/harsh.jpg"} alt="Bootstrap" width="75%"  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
              ...
              <div class="col">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/Anirudh.jpeg"} alt="Bootstrap" width="75%"  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
        ...
        <div className="container mt-4">
              ...
              <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/Shruti.jpg"} alt="Bootstrap" width="75%" style={{contentFit:"cover"}}  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
              ...
              <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/DevDesai.jpg"} alt="Bootstrap" width="75%" style={{contentFit:"cover"}}  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
         ...
         <div className="container ">
              ...
              <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/Sudeepta.jpg"} alt="Bootstrap" width="75%"  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
                ...
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/Vidushi.jpeg"} alt="Bootstrap" width="75%"  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
               ...
               <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/Tambade.jpg"} alt="Bootstrap" width="75%" style={{contentFit:"cover"}}  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
        ...
        <hr/>
         ...
         <div className="container mt-4 mt-5">
            ...
            <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/yash.jpg"} alt="Bootstrap" width="75%" style={{contentFit:"cover"}}  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
               ...
               <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/vaibhav.jpg"} alt="Bootstrap" width="75%"  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
            ...
            <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/Nitish.jpeg"} alt="Bootstrap" width="75%" style={{contentFit:"cover"}}  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
             ...
             <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/Rushil.jpeg"} alt="Bootstrap" width="75%" style={{contentFit:"cover"}}  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
              ...
              <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/Nihar.jpeg"} alt="Bootstrap" width="75%" style={{contentFit:"cover"}}  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
              ...
              <div class="col m-auto">
                <div class=" h-100 overflow-hidden  rounded-4" >
                  <div class="d-flex flex-column h-100 p-4 pb-3 text-shadow-1">
                    <img src={"./22-23/balbir5.jpeg"} alt="Bootstrap" width="75%" style={{contentFit:"cover"}}  class="rounded-circle border border-white m-auto " loading='lazy'/>
                     <ul class="d-flex list-unstyled mt-auto">
                      <li class="m-auto py-2">
                        <div className='d-flex flex-column m-auto '>
